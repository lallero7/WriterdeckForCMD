...
# Windows compatibility: `pip install windows-curses` patches the std curses module
if sys.platform == "win32":
    try:
        import _curses  # noqa: F401 — provided by windows-curses
    except ImportError:
...
DOCS_DIR = os.path.expanduser("~/documents/writerdeck")
...
def main(stdscr):
    ...
    try:
        curses.set_escdelay(25)  # not supported on all Windows builds
